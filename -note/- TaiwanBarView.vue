...
<template>
  <div
    class="relative mt-3xl min-h-[472px] min-w-[344px] border-2 border-black sm:min-h-[699px] sm:min-w-[510px]"
  >
    <!-- 連江 -->
    <svg
      class="svg-rwd absolute left-[155px] top-[33px]"
    ...
    <!-- 金門 -->
    <svg
      class="svg-rwd absolute left-[0px] top-[194px]"
    ...
    <!-- 基隆 -->
    <svg
      class="absolute left-[481px] top-[72px] h-[5%] w-[5%]"
      xmlns="http://www.w3.org/2000/svg"
      width="37"
      height="29"
      viewBox="0 0 37 29"
    ...
    <!-- 新北 -->
    <svg
      class="absolute left-[322px] top-[0px] h-[15%] w-[15%]"
      xmlns="http://www.w3.org/2000/svg"
      width="141"
      height="112"
      viewBox="0 0 141 112"
    ...
    <img
      class="absolute left-[361px] top-[29px] h-[15%] w-[15%]"
      src="~/assets/img/map/臺北市.png"
      alt=""
    />
    <!-- 桃園市 -->
